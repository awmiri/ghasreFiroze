...
import EditReqPage from "./EditReqPage";
...
function ItemBox() {
  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between border-b border-b-slate-300 pb-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              ...
              className="bg-blue-400 hover:bg-blue-500/50 transition-all cursor-pointer block p-1.5 text-white rounded-full"
            >
              <Pen size={18} />
            </span>
          </div>
      ...
      {openEditPage && (
        <>
          <EditReqPage onClose={() => setOpenEditPage(false)} />
          <div className="bg-white/10 backdrop-blur-[2px] w-full h-full absolute top-0 left-0 z-30"></div>
        </>
      )}
    </>
  );
